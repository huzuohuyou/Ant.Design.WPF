...
namespace AntdDemo.ViewModels
{
    public class NavigationComponentViewModel : ViewModelBase
    {
          ...
          : base(regionManager, dialogService, ea)
        {
            ...
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "通用", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "------", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Button按钮", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Icon图标", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Typography排版", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "布局", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "------", Count = 2 });
            ...
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "导航", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "-------", Count = 2 });
            ...
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "数据录入", Count = 2 });
            ...
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Checkbox多选框", Count = 2 });
            ...
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Input输入框", Count = 2 });
            ...
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Radio单选框", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Rate评分", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Select选择器", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Slider滑动输入条", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Switch开关", Count = 2 });
            ...
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "数据展示", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Avatar头像", Count = 2 });
            ...
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Tag标签", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Timeline时间轴", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Tooltip文字提示", Count = 2 });
            ...
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "Spin加载中", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "其他", Count = 2 });
            MenuItems.Add(new MenuItem() { Icon = "", BackColor = "#1890ff", Name = "--------", Count = 2 });
